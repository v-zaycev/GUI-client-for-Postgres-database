COPY diagnosis (name) FROM 'C:\Users\vozon\GUI-client-for-Postgres-database\database\resources\diagnosis.txt' DELIMITER ',' ENCODING 'UTF8';
COPY wards (name, max_count, diagnosis_id) FROM 'C:\Users\vozon\GUI-client-for-Postgres-database\database\resources\wards.txt' DELIMITER ',' ENCODING 'UTF8';
COPY people (first_name, last_name, father_name, diagnosis_id, ward_id) FROM 'C:\Users\vozon\GUI-client-for-Postgres-database\database\resources\people.txt' DELIMITER ',' ENCODING 'UTF8';
